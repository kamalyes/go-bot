...
* @Date: 2026-09-18 16:06:00
* @LastEditors: kamalyes 501893067@qq.com
* @LastEditTime: 2026-09-18 20:56:36
* @FilePath: \go-bot\dingtalk\dingtalk_test.go
* @Description: dingtalk 适配器构造与配置测试
*
...
func TestPlatform(t *testing.T) {
	...
	if got := adapter.Platform(); got != gobot.PlatformDingtalk {
		t.Fatalf("Platform() = %q, 期望 %q", got, gobot.PlatformDingtalk)
	}
}
